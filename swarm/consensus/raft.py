"""
Raft Consensus Protocol for the Hayek Economy

Adapted from NecroSwarm's consensus protocols. Implements Raft, Gossip,
and Quorum-based consensus mechanisms for reliable distributed
decision-making in agent swarms.

Used by the HayekMAS engine for distributed ledger and agent coordination.
"""
...
class GossipProtocol:
    ...
    async def _handle_sync(self, msg: GossipMessage) -> None:
        ...
        self._failure_detector[msg.sender_id] = (time.time(), 0)
